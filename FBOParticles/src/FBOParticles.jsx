...
import vertexShader from './tutorialShaders/vertexShader.glsl'
import fragmentShader from './tutorialShaders/fragmentShaderjs.js'
import { useControls } from "leva";


export default function FBOParticles({ count }) {
